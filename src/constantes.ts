...
export const API_CONTROLLER_EMAIL_URL = process.env.NEXT_PUBLIC_API_EMAIL_URL;
export const API_CONTROLLER_USERCONTROLLER_URL = process.env.NEXT_PUBLIC_API_GETALLUSERS_URL;
export const API_CONTROLLER_VEHICULOSCONTROLLER_URL = process.env.NEXT_PUBLIC_API_GETALLVEHICULOS_URL;
...
export const API_CONTROLLER_GETUSERBYDOC_URL = process.env.NEXT_PUBLIC_API_GETUSERBYDOCUMENT_URL;
